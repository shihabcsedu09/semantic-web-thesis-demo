...
/**
 * Created by Shihab on 3/8/14.
 */
public class KWONCalculate {
    public static double calculateKWON(ArrayList<ClusterCentreEntity> clusterCentres) throws IOException {
